...
const ScoreSubmissionBlock = ( {startScore, deductions, penalties} ) => {
  return (
    <div className="w-full flex flex-col items-start justify-center gap-4 px-4 md:px-16 py-4 bg-white rounded-lg shadow-md">
      <div className="w-full grid grid-cols-2 gap-2 text-prussian-blue font-montserrat font-medium text-base md:text-lg lg:text-xl">
